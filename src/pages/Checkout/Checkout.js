...
function Checkout(props) {
  ...
  const onClickOrderPost = () => {
    let r = Math.random().toString(36).substring(2, 8) + Math.random().toString(36).substring(2, 8);
    let pId = r && r.match(/.{1,4}/g);
    let idProduct = pId && pId.join(' ');
    let orderDetails = {
      orderedItems: [],
      total: getTotal(getSubTotal(carts), getTax(getSubTotal(carts)), getServiceCharge(getSubTotal(carts))),
    ...
    <div className='container'>
      <div className='row'>
        <div className='col-xs-12 col-sm-12 col-md-12 col-xl-12 pl-4 pt-4 pb-2' style={{ margin: `0 !important`, padding: '0!important' }}>
          ...
          <h3 className='text-uppercase mb-3 text-center text-dark'>Checkout</h3>
        </div>
      </div>
      <div className='row mb-5'>
        <div className='col-xs-12 col-sm-12 col-md-12 col-xl-12'>
          <ul id='progressbar' className='text-center'>
            <li className='step0 active' style={{ fontWeight: '500', fontSize: '19px' }}>
              User Details{' '}
            </li>
            ...
            {userData ? (
              ...
              <li className=' step0' style={{ fontWeight: '500', fontSize: '19px' }}>
                Addresses
              </li>
            )}
          ...
          <div className='col-xs-12 col-sm-12 col-md-6 col-xl-6 mt-4'>
            ...
            <form onSubmit={handleSubmit(handleSubmitForm)}>
              <div className='form-group'>
                ...
                {errors.zone && errors.zone.type === 'required' && <p className='text-danger'> * Province Name is required.</p>}
              </div>
              <div className='form-group'>
              ...
              <div className='form-group'>
                ...
                {errors.phone && errors.phone.type === 'required' && <p className='text-danger'> * Phone Number is required.</p>}
              </div>
          ...
          <table className='table table-xs '>
            ...
            <tr className='total-row info'>
              ...
              <td className='text-right'>
                <span className='font-weight-bold'>Rs. {getSubTotal(carts)}</span> <br />
                <span className='font-weight-bold'>Rs. {getTax(getSubTotal(carts))}</span> <br />
              ...
              <form action=''>
                <div className='form-group'>
                  ...
                  <div
                    ...
                    style={{ justifyContent: 'flex-end', flexDirection: 'row-reverse', alignItems: 'center' }}
