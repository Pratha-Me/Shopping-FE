              ...
              <div className='col-xs-12 col-sm-12 col-md-2 offset-md-7'>
                <div className='dropdown text-center'>
                  ...
                  <div className='dropdown-menu' aria-labelledby='dropdownMenuButton'>
                    <button className='btn dropdown-item' onClick={() => handleSort(true)}>
                      Low to High
                    </button>
                    <div className='dropdown-divider'></div>
                    <button className='btn dropdown-item' onClick={() => handleSort(false)}>
                      High to Low
                    </button>
                  </div>
                </div>
          ...
          <div className='container-fluid'>
            <div className='row'>
                        ...
                        <article className='filter-group'>
                          ...
                          <div className='card-body'>
                            <div className='form-group' style={priceFilterStyle}>
                              <input name='description' className='form-control price-filter-from' placeholder='Search Keywords' onChange={handleOnChangeDescription} style={priceInputStyle} />
                            </div>
                          </div>
                        </article>
                        <article className='filter-group'>
                            ...
                            <div className='card-body'>
                              {brand &&
                                brand.map((brandName, idx) => {
                                  return (
                                    <label key={idx} className='custom-control'>
                                      <input type='checkbox' className='custom-control-input' value={brandName} onClick={handleBrand} />
                                      <div className='custom-control-label'>{brandName}</div>
                                    </label>
                                  );
                                })}
                            </div>
              ...
              <div className='col-md-9 col-sm-12 col-xs-12'>
                <div className='row'>
                  {items.map((item, idx) => (
                    <div key={idx} className='col-lg-3 col-md-3 col-sm-6 col-xs-6'>
