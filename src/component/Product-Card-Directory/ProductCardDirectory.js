    ...
    >
      {catName && (
        <>
          ...
          <Link
            to={`/browser/${productsName && productsName}/${
      ...
      <ItemsCarousel
        ...
        gutter={cardGutter}
        leftChevron={
          <i className='fas fa-chevron-left carousel-arrow-both'></i>
        }
        rightChevron={
          <i className='fas fa-chevron-right carousel-arrow-both'></i>
        }
        outsideChevron
